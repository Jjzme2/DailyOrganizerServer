		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				VALUES (
					...
					<cfqueryparam value="#entity.geteventDetailsId()#"	cfsqltype="cf_sql_varchar">,
				)
			</cfquery>
		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				SET
					...
					,t.eventDetailsId = <cfqueryparam value="#entity.getEventDetailsId()#"  cfsqltype="cf_sql_varchar">
	    ...
	    <cftry>
			<cfquery name="list" datasource=#dataSource#>
				SELECT
					...
					,eventDetailsId as event_detailsId
