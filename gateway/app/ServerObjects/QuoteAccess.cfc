		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				VALUES (
					...
					<cfqueryparam value="#entity.getQuoteAuthor()#"	cfsqltype="cf_sql_varchar">,
					<cfqueryparam value="#entity.getQuoteText()#"	cfsqltype="cf_sql_varchar">,
				)
			</cfquery>
		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				SET
					...
					,t.author	   = <cfqueryparam value="#entity.getQuoteAuthor()#" cfsqltype="cf_sql_varchar">
					,t.quote  	   = <cfqueryparam value="#entity.getQuoteText()#" 	 cfsqltype="cf_sql_varchar">
