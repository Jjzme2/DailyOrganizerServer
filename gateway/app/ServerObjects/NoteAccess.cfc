		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				VALUES (
					...
					<cfqueryparam value="#entity.getContent()#"	    cfsqltype="cf_sql_varchar">,
				)
			</cfquery>
		...
		<cftry>
			<cfquery datasource=#dataSource#>
				...
				SET
					...
					,t.content	   = <cfqueryparam value="#entity.getContent()#"     cfsqltype="cf_sql_varchar">
